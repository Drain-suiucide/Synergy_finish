...
class Main(tk.Frame):
    ...
    def init_main(self): # Метод со всеми графическими элементами
        #Frame = виджет для группировки и организации других виджетов в  приложении
        ...
        btn_delete.pack(side=tk.LEFT)                               # Размещение кнопку в окне, указывавая где она будет находиться
        ...
        btn_search.pack(side=tk.LEFT)                                                   # Размещение кнопку в окне, указыввая где она будет находиться
...
class DB:
    ...
    def data(self):
        ...
        user_data=('Ivan', '+79134490277', 'legendarka.zgtr@gmail.com','120000')
        user_data1=('Sarah', '+79995889101', 'Sarah_Thompson@gmail.com','12000')
        user_data2=('Vladislav', '+79891111122', 'Vlad1989@yandex.com','100000')
        user_data3=('Gregory', '+79051922260', 'PGV_9999@gmail.com','100009')
        user_data4=('Alekasndra', '+79831115543', 'ALEX@yandex.com','90000')
